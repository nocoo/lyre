...
export function toBasicRecordingsListVM(response: PaginatedResponse<Recording>): RecordingsListVM {
	return {
...
export function bulkFilterRecordings(
	...
	for (const card of cards) {
		if (criteria.createdBefore !== undefined && card.createdAtMs < criteria.createdBefore) {
