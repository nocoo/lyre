...
> **2026-09-15 更新**：当前行为以 [macOS 录音可靠性与提醒优化](10-macos-recording-reliability.md#teams-提醒)为准：新安装默认关闭；持续音频证据加 10/30 秒确认；不激活应用的临时提醒；结束建议仅对应从提醒启动的录音。下文保留旧版设计和调查过程，其中默认开启、窗口数量判据和模态对话框已被替换。
